                    ...
                    children: <Widget>[
                      ...
                      OutlinedButton(
                        ...
                        onPressed:  _connected?() async {
                          ...
                          list.add(LineText(type: LineText.TYPE_TEXT, content: 'naseeff', weight: 1, align: LineText.ALIGN_LEFT, x: 0,relativeX: 0, linefeed: 0));
                          list.add(LineText(type: LineText.TYPE_TEXT, content: 'naseeff', weight: 1, align: LineText.ALIGN_LEFT, x: 0,relativeX: 0, linefeed: 0));
                          ...
                          list.add(LineText(type: LineText.TYPE_TEXT, content: 'മലയാളം ടൈപ്പിംഗ് ...', weight: 1, align: LineText.ALIGN_LEFT, x: 350, relativeX: 0, linefeed: 0));
